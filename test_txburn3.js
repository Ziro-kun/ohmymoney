...
const transactions = [
  { isFixed: true, isVirtual: false, type: "expense", amount: 200000 }, // Jeonse Interest
  { isFixed: true, isVirtual: false, type: "transfer", amount: 300000 }, // Credit Loan Repay
  { isFixed: true, isVirtual: false, type: "transfer", amount: 100000 }, // Saving transfer
  { isFixed: true, isVirtual: false, type: "expense", amount: 17000 }, // Netflix
  { isFixed: true, isVirtual: false, type: "expense", amount: 14900 }, // Youtube
];
const txBurn = transactions.reduce((total, tx) => {
  const amt = Number(tx.amount) || 0;
  // Count BOTH FIXED EXPENSES AND FIXED TRANSFERS (like loan repayments). 
  // Wait, saving is also a fixed transfer! We should probably only count loan repayments as burn rate, not savings.
