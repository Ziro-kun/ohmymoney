...
const styles = StyleSheet.create({
  ...
  modalContent: { borderTopLeftRadius: 32, borderTopRightRadius: 32, padding: 24, minHeight: "70%", maxHeight: "90%", borderWidth: 1 },
  ...
  input: { height: 54, borderRadius: 16, borderWidth: 1, paddingHorizontal: 16, marginBottom: 16, fontSize: 16 },
  assetScroll: { marginBottom: 24 },
  assetBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 14, borderWidth: 1, marginRight: 10, minWidth: 100, alignItems: "center" },
  modeContainer: { flexDirection: 'row', gap: 12, marginTop: 10 },
  modeBtn: { flex: 1, padding: 20, borderRadius: 20, borderWidth: 1.5, alignItems: 'center', gap: 8 },
